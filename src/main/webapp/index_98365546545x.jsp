...
<html lang="en">
  ...
  <body style="background-image: url('images/ENS2.jpg');background-repeat: no-repeat;background-size: cover;">
      ...
      <header class="site-navbar site-navbar-target py-4" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3">
              <div class="site-logo">
                <a href="index.html" class="font-weight-bold text-white"><img width="150" height="150" src="images/ENS.png" alt="ENS"></a>
              </div>
            </div>
