                ...
                <form id="productForm" action="viewProduct.php" method="post">
				    <fieldset>
				        ...
				        <div class="mb-3">
				            ...
				            <input type="text" id="cne" name="cne" class="form-control" placeholder="Cne">
				        </div>
				        <div class="mb-3">
				        ...
				        <div class="mb-3">
				            ...
				            <input type="text" id="departement" name="departement" class="form-control" placeholder="Departement">
				        </div>
				        <div class="mb-3">
				            <label class="form-label">Filiere</label>
				            <input type="text" id="filiere" name="filiere" class="form-control" placeholder="Filiere">
				        </div>
				        <div class="mb-3">
